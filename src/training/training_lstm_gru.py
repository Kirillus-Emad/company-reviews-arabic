...
from models.lstm_gru_model import RNNSentiment
from config import (
    PROC_TRAIN_DF, PROC_TEST_DF,
    TEXT_COLUMN, TARGET_COLUMN,
    LABEL_ENCODE_MAP, LABEL_DECODE_MAP,
    TRANS_VAL_SPLIT,
    LSTM_MAX_SEQ_LEN, LSTM_EMBED_DIM, LSTM_HIDDEN_DIM, LSTM_NUM_LAYERS,
    LSTM_DROPOUT, LSTM_REC_DROPOUT, LSTM_BATCH_SIZE,
